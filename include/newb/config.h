...
#define NL_MORNING_SUN_COL vec3(0.29, 0.35, 0.48)
#define NL_NOON_SUN_COL    vec3(0.21, 0.34, 0.53)
#define NL_NIGHT_SUN_COL   vec3(0.27, 0.43, 0.65)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(0.85,0.41,0.1)
#define NL_UNDERWATER_TORCH_COL vec3(0.85,0.41,0.1)
#define NL_NETHER_TORCH_COL     vec3(0.85,0.41,0.1)
#define NL_END_TORCH_COL        vec3(0.85,0.41,0.1)

/* Fog */
#define NL_FOG_TYPE 2        // 0:no fog, 1:vanilla, 2:smoother vanilla
#define NL_MIST_DENSITY 2.12 // 0.0 no mist ~ 1.0 misty

/* Sky colors - zenith=top, horizon=bottom */
#define NL_DAY_ZENITH_COL    vec3(0.22, 0.35, 0.8)
#define NL_DAY_HORIZON_COL   vec3(0.22, 0.67, 0.83)
#define NL_NIGHT_ZENITH_COL  vec3(0, 0.005, 0.016)
#define NL_NIGHT_HORIZON_COL vec3(0.02, 0.2, 0.47)
#define NL_RAIN_ZENITH_COL   vec3(0.31, 0.37, 0.48)
#define NL_RAIN_HORIZON_COL  vec3(0.46, 0.53, 0.64)
#define NL_END_ZENITH_COL    vec3(0.22, 0.35, 0.8)
#define NL_END_HORIZON_COL   vec3(0.22, 0.67, 0.83)
#define NL_DAWN_HORIZON_COL  vec3(0.46, 0.53, 0.64)
#define NL_DAWN_EDGE_COL     vec3(0.4, 0.38, 0.45)
...
//#define NL_LANTERN_WAVE 0.07   // [toggle] 0.05 subtle ~ 0.4 large swing
#define NL_WAVE_SPEED 2.95      // 0.5 slow wave ~ 5.0 very fast wave
...
#define NL_WATER_TINT vec3(0.22, 0.35, 0.8)
...
#define NL_UNDERWATER_TINT vec3(0.22, 0.35, 0.8)
...
#define NL_CLOUD2_STEPS 11         // 3 low quality ~ 16 high quality
#define NL_CLOUD2_SCALE 0.015        // 0.003 large ~ 0.3 tiny
#define NL_CLOUD2_SHAPE 0.4    // 0.0 round ~ 1.0 box
...
/* Rain effects */
#define NL_RAIN_MIST_OPACITY 0.5 // [toggle] 0.04 very subtle ~ 0.5 thick mist blow
#define NL_RAIN_WETNESS 1.5       // 0.0 no wetness - 1.0 fully wet blocks
#define NL_RAIN_PUDDLES 1.5       // 0.0 no puddles - 1.0 puddles
